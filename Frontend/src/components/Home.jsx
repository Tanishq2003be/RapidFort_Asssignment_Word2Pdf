...
function Home() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            setDownloadUrl(`http://localhost:3000${response.data.downloadPath}`);
            setMetadata(response.data.metadata);
            setConvert("File Converted Successfully");
        } catch (error) {
            console.log(error);
            setConvert("Error occurred during conversion");
        }
    };
                ...
                <div className="border-2 border-dashed px-4 py-2 md:px-8 md:py-6 border-indigo-400 rounded-lg shadow-lg">
                    ...
                    <div className="flex flex-col items-center space-y-4">
                        ...
                        {downloadUrl && (
                            ...
                            >
                                <button
                                    className="text-white bg-green-500 hover:bg-green-700 duration-300 font-bold px-4 py-2 mt-4 rounded-lg shadow-lg"
                                >
                                    Download
                                </button>
                            </a>
                        ...
                        {metadata && (
                            <div className="w-full text-left mt-4">
                                ...
                                <pre className="bg-gray-100 p-4 rounded-lg text-sm w-full">
